package arun.pkg.practice.hamilton_cycle;
...
public class HamiltonianCycle {
	public static void printAllHamiltonianPaths(Main g, int v, boolean[] visited, List<Integer> path, int N) {
